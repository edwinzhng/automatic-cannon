...
def detectFace():
    ...
    url = "http://api.skybiometry.com/fc/faces/recognize?namespaces=se101&api_key=" + api_key + "&api_secret=" + api_secret + "&urls=" + img_url + "&uids=ayush@se101,rollen@se101,derek@se101"
    r = requests.get(url)
